            ...
            {fields.map((field) => (
              <div key={field.name}>
                ...
                <input
                  ...
                  className={`w-full bg-transparent outline-none placeholder:text-gray-600 dark:text-gray-100 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 
